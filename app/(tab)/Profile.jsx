        ...
        <ScrollView>
          ...
          <View className="flex m-2 px-4 space-y-5">
            ...
            <View className="flex">
              ...
              <Text className="text-sm ">
                Review your activity and orders that you placed
              </Text>
            </View>

            <TouchableOpacity
              onPress={() => router.push("MyBusiness")}
            ...
            >
              ...
              <Text className="text-[16px] text-black">My Businesses</Text>
            </TouchableOpacity>

            <TouchableOpacity
              onPress={() => router.push("MyWebsites")}
              className="flex-row items-center text-center "
            >
              <Icon
                name="basket-outline"
              ...
              <Text className="text-[16px] text-black">My Websites</Text>
            </TouchableOpacity>
            ...
            >
              ...
              <Text className="text-[16px] text-black">Orders</Text>
            </TouchableOpacity>
            ...
            <View className="flex">
              ...
              <Text className="text-sm ">
                Manage your Payments info and activity.
              </Text>
            </View>
            <TouchableOpacity
            ...
            >
              ...
              <Text className="text-[16px] text-black ">Payouts</Text>
            </TouchableOpacity>
            ...
            <View className="flex">
              ...
              <Text className="text-sm ">
                Manage your Brandify information.
              </Text>
            </View>
            ...
            >
              ...
              <Text className="text-[16px] text-black ">Profile Edit</Text>
            </TouchableOpacity>
            ...
            >
              ...
              <Text className="text-[16px] text-black">Settings</Text>
            </TouchableOpacity>
            ...
            >
              ...
              <Text className="text-[16px] text-black ">Contact us</Text>
            </TouchableOpacity>
            ...
            >
              ...
              <Text className="text-[16px] text-black">Report a Bug</Text>
            </TouchableOpacity>
          </View>
          ...
          <View className="justify-center items-center px-4">
            <TouchableOpacity
              ...
              className="flex-row items-center  mt-3 rounded-2xl py-2 px-5 border"
            >
              <Text className="text-[13px] font-bold text-black">Logout</Text>
              <Icon
                name="log-in-outline"
                size={23}
                color="black"
