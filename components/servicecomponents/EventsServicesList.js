...
const items = [
  { name: 'Wedding', icon: 'facebook', route: 'Wedding' },
  { name: 'Google Ads', icon: 'google-ads', route: 'Wedding' },
  { name: 'YouTube', icon: 'youtube', route: 'Wedding' },
  { name: 'Google My Business', icon: 'google-my-business', route: 'Wedding' },
...
const EventsServicesList = () => {
  ...
  return (
    <StyledView className="bg-teal-800 p-4 rounded-lg m-2">
      <StyledText className="text-white text-md mb-4">Events</StyledText>
